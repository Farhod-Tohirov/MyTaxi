...
fun Fragment.checkPermissionAndGetLastLocation(location: (Location) -> Unit) {
...
fun Fragment.checkLocationPermissions(granted: () -> Unit) {
    requireActivity().checkPermissions(arrayOf(android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.ACCESS_COARSE_LOCATION), granted)
}
